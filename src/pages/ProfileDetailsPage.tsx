...
const STUB_KEYS: AtProtoRecord<MeAttestKey.Main>[] = [
  ...
  {
    uri: "at://did:plc:stub1234/me.attest.key/ssh2",
    cid: "bafyreisshkey2234567890abcdefghijklmnopqrst",
    value: {
      $type: "me.attest.key",
      keyType: "ssh-ecdsa",
      publicKey:
        "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBExampleRevokedKeyData manoo@old-laptop",
      fingerprint: "SHA256:rEvOkEdKeYrEvOkEdKeYrEvOkEdKeYrEvOkEdKeYrEvO",
      label: "Old laptop",
      comment: "Replaced — revoked after hardware change",
      status: "revoked",
      createdAt: "2024-06-01T09:00:00.000Z",
    },
  },
  {
    uri: "at://did:plc:stub1234/me.attest.key/pgp2",
    cid: "bafyreipgpkey2234567890abcdefghijklmnopqrst",
    value: {
      $type: "me.attest.key",
      keyType: "pgp",
      publicKey:
        "-----BEGIN PGP PUBLIC KEY BLOCK-----\nmQINBExpired...example...\n-----END PGP PUBLIC KEY BLOCK-----",
      fingerprint: "B2C3D4E5F6A1B2C3D4E5F6A1B2C3D4E5F6A1B2C3",
      label: "Old signing key",
      comment: "Expired — superseded by current key",
      status: "active",
  ...
  {
    uri: "at://did:plc:stub1234/me.attest.key/pgp3",
    cid: "bafyreipgpkey3234567890abcdefghijklmnopqrst",
    value: {
      $type: "me.attest.key",
      keyType: "pgp",
      publicKey:
        "-----BEGIN PGP PUBLIC KEY BLOCK-----\nmQINBExpiredAndRevoked...example...\n-----END PGP PUBLIC KEY BLOCK-----",
      fingerprint: "C3D4E5F6A1B2C3D4E5F6A1B2C3D4E5F6A1B2C3D4",
      label: "Emergency key",
      comment: "Revoked and expired",
      status: "revoked",
